...
import java.io.*;
/**
 * Creates the modified deck for the modified Uncle Wiggily game.
 * 
 * @Ryan Egan
 * @HW #1
 */
...
{
    private ArrayList<Card> currentDeck = new ArrayList<Card>(56);
    private ArrayList<Card> originalDeck = new ArrayList<Card>(56);
     ...
     * @returns an array list full of 56 cards.
     */
    public ArrayList shuffleDeck(){
       currentDeck.add(new Card(10,"A cabbage lollipop now and then, will gain Uncle Wiggily a hop of ten!"));
        ...
        currentDeck.add(new Card(1,"The fox thinks he just won, but Uncle Wiggily hops ahead one."));
        currentDeck.add(new Card(6,"Uncle Wiggily jumps ahead six with pride, but really just wants to play 'Ticket to Ride!'")); 
        currentDeck.add(new Card(1,"Uncle Wiggily plays at twilight and moves ahead one; he also plays all night, up to the midnight sun."));
        currentDeck.add(new Card(-4,"Uncle Wiggily plays golf, and yells out 'Fore'; he hits someone in the fairway and hops back four.")); 
        currentDeck.add(new Card(1,"Snuffles the Bear rolls forward one with glee; Uncle Wiggily joins him, for a small fee."));
        currentDeck.add(new Card(1,"Uncle Wiggily does not have hexproof; that is easy to see.  Uncle Wiggily jumped forward one, after being bolted for three!"));
        currentDeck.add(new Card(2,"Uncle Wiggily likes Pepsi and Mountain Dew; Uncle Wiggily drinks too much and staggers ahead two."));
        currentDeck.add(new Card(1,"Uncle Wiggily moves up one and eats a Kit-Kat.  He eats 30 more and throws up in his hat."));
        currentDeck.add(new Card(1,"Uncle Wiggily takes a quiz and moves ahead five.  He forgets semicolons, and four spaces back he will dive."));
        return currentDeck;
    ...
    /**
     * This is a method to read in a deck of cards from a file. This did not fully work because of memory issues.
     * @param String filename is the location of the file to be read in
     * @return ArrayList the full deck
     */
    public ArrayList initializeDeck(String filename){
        Scanner inFile = null;
        try{
        ...
        while(inFile.hasNextLine()){
           ...
           Integer i = Integer.parseInt(words[1].trim());
           String b = words[0];
           originalDeck.add(new Card(i,b));
        }
        inFile.close();
